...
const navigation = [
    ...
    { name: 'Pujas', href: '/dashboard/bids', icon: BanknotesIcon, current: true },
                    ...
                    <main className="flex-1">
                        <div className="py-6">
                            <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                                <h1 className="text-2xl mt-12    font-semibold text-gray-900">Pujas</h1>
                            </div>
                            <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 mr-12">
                                                                ...
                                                                <tr key={index}>
                                                                    ...
                                                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                                        <div className="text-gray-900">
                                                                            {sneakers.find(sneaker => sneaker._id === bid.productId)?.name || "Sneaker no encontrado"}
                                                                        </div>
                                                                    </td>
                                                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                                    ...
                                                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                                        <div className="text-gray-900">
                                                                            {user.find(user => user._id === bid.userId)?.username || "Usuario no encontrado"}
                                                                        </div>
                                                                    </td>
                                                                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
